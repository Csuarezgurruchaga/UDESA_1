...
(serial_number) 
 ...
 INSERT INTO contact     VALUES 
    (8001,'Leblanc, James',805,2213456,221,sysdate - 87);

 INSERT INTO contact     VALUES 
    (8005,'Hughes, Jack',212,5432126,710,sysdate - 82);

 INSERT INTO contact     VALUES 
    (8007,'Smith, Ginny',408,3792152,333,sysdate - 77);

 INSERT INTO contact     VALUES 
    (8008,'Torres, Alison',802,5487890,444,sysdate - 72);

 INSERT INTO contact     VALUES 
    (8009,'Dibble, Nancy',602,2713387,652,sysdate - 67);
 ...
 INSERT INTO employee VALUES 
   (1001,1003,401,412101,'Hoover','William',sysdate - 776,25525);

 INSERT INTO employee VALUES 
   (1002,1003,401,413201,'Brown','Alan',sysdate - 310,43100);

 INSERT INTO employee VALUES 
   (1003,0801,401,411100,'Trader','James',sysdate - 310,37850);

 INSERT INTO employee VALUES 
   (1004,1003,401,412101,'Johnson','Darlene',sysdate - 15,36300);

 INSERT INTO employee VALUES 
   (1005,0801,403,431100,'Ryan','Loretta',sysdate - 312,31200);

 INSERT INTO employee VALUES 
   (1006,1019,301,312101,'Stein','John',sysdate - 920,29450);

 INSERT INTO employee VALUES 
   (1007,1005,403,432101,'Villegas','Arnando',sysdate - 546,49700);

 INSERT INTO employee VALUES 
   (1008,1019,301,312102,'Kanieski','Carol',sysdate - 66,29250);

 INSERT INTO employee VALUES 
   (1009,1005,403,432101,'Lombardo','Domingus',sysdate - 84,31000);

 INSERT INTO employee VALUES 
   (1010,1003,401,412101,'Rogers','Frank',sysdate - 9,46000);

 INSERT INTO employee VALUES 
   (1011,0801,402,421100,'Daly','James',sysdate - 84,52500);

 INSERT INTO employee VALUES 
   (1012,1005,403,432101,'Hopkins','Paulene',sysdate - 33,37900);

 INSERT INTO employee VALUES 
   (1013,1003,401,412102,'Phillips','Charles',sysdate - 23,24500);

 INSERT INTO employee VALUES 
   (1014,1011,402,422101,'Crane','Robert',sysdate - 222,24500);

 INSERT INTO employee VALUES 
   (1015,1017,501,512101,'Wilson','Edward',sysdate - 1,53625);

 INSERT INTO employee VALUES 
   (1016,0801,302,321100,'Rogers','Nora',sysdate - 2345,56500);

 INSERT INTO employee VALUES 
   (1017,0801,501,511100,'Runyon','Irene',sysdate - 3,66000);

 INSERT INTO employee VALUES 
   (1018,1017,501,512101,'Ratzlaff','Larry',sysdate - 34,54000);

 INSERT INTO employee VALUES 
   (1019,0801,301,311100,'Kubic','Ron',sysdate - 365,57700);

 INSERT INTO employee VALUES 
   (1020,1005,403,432101,'Charles','John',sysdate - 33,39500);

 INSERT INTO employee VALUES 
   (1021,1025,201,222101,'Morrissey','Jim',sysdate - 92,38750);

 INSERT INTO employee VALUES 
   (1022,1003,401,412102,'Machado','Albert',sysdate - 33,32300);

 INSERT INTO employee VALUES 
   (1023,1017,501,512101,'Rabbit','Peter',sysdate - 232,26500);

 INSERT INTO employee VALUES 
   (1024,1005,403,432101,'Brown','Allen',sysdate - 1,43700);

 INSERT INTO employee VALUES 
   (1025,0801,201,211100,'Short','Michael',sysdate - 23,34700);
...
insert into daily_sales values (10,sysdate - 1,150);

insert into daily_sales values (10,sysdate - 2,200);

insert into daily_sales values (10,sysdate - 3,250);

insert into daily_sales values (10,sysdate - 5,350);

insert into daily_sales values (10,sysdate - 10,550);

insert into daily_sales values (10,sysdate - 21,150);

insert into daily_sales values (10,sysdate - 25,200);

insert into daily_sales values (10,sysdate - 31,100);

insert into daily_sales values (10,sysdate - 15,150);

insert into daily_sales values (10,sysdate - 3,250);

insert into daily_sales values (10,sysdate - 6,350);

insert into daily_sales values (10,sysdate - 17,550);

insert into daily_sales values (10,sysdate - 20,450);

insert into daily_sales values (10,sysdate - 27,350);

insert into daily_sales values (10,sysdate - 1,350);

insert into daily_sales values (10,sysdate - 2,100);

insert into daily_sales values (10,sysdate - 2,250);

insert into daily_sales values (10,sysdate - 5,350);

insert into daily_sales values (10,sysdate - 5,450);

insert into daily_sales values (10,sysdate - 21,250);

insert into daily_sales values (10,sysdate - 1,300);

insert into daily_sales values (10,sysdate - 1,100);

insert into daily_sales values (10,sysdate - 1,550);

insert into daily_sales values (10,sysdate - 1,350);

insert into daily_sales values (10,sysdate - 1,150);

insert into daily_sales values (10,sysdate - 1,250);

insert into daily_sales values (10,sysdate - 1,500);

insert into daily_sales values (10,sysdate - 1,150);

insert into daily_sales values (10,sysdate - 2,150);

insert into daily_sales values (10,sysdate - 3,200);

insert into daily_sales values (10,sysdate - 4,250);

insert into daily_sales values (10,sysdate - 5,250);

insert into daily_sales values (10,sysdate - 6,350);

insert into daily_sales values (10,sysdate - 7,550);

insert into daily_sales values (10,sysdate - 8,150);

insert into daily_sales values (10,sysdate - 9,200);

insert into daily_sales values (10,sysdate - 10,100);

insert into daily_sales values (10,sysdate - 11,150);

insert into daily_sales values (10,sysdate - 12,250);

insert into daily_sales values (10,sysdate - 13,350);

insert into daily_sales values (10,sysdate - 14,450);

insert into daily_sales values (10,sysdate - 13,550);

insert into daily_sales values (10,sysdate - 3,450);

insert into daily_sales values (10,sysdate - 16,350);

insert into daily_sales values (10,sysdate - 1,150);

insert into daily_sales values (10,sysdate - 1,200);

insert into daily_sales values (10,sysdate - 1,250);

insert into daily_sales values (10,sysdate - 1,350);

insert into daily_sales values (10,sysdate - 5,550);

insert into daily_sales values (10,sysdate - 5,150);

insert into daily_sales values (10,sysdate - 5,200);

insert into daily_sales values (10,sysdate - 5,100);
...
insert into jan_sales values (10,sysdate - 3,150);

insert into jan_sales values (10,sysdate - 3,200);

insert into jan_sales values (10,sysdate - 30,250);

insert into jan_sales values (10,sysdate - 30,350);

insert into jan_sales values (10,sysdate - 30,550);

insert into jan_sales values (10,sysdate - 30,150);

insert into jan_sales values (10,sysdate - 30,200);

insert into jan_sales values (10,sysdate - 30,100);
...
insert into jan_sales values (10,sysdate - 30,450);

insert into jan_sales values (10,sysdate - 30,350);

insert into jan_sales values (11,sysdate - 60,350);

insert into jan_sales values (11,sysdate - 60,100);

insert into jan_sales values (11,sysdate - 60,450);

insert into jan_sales values (11,sysdate - 60,550);

insert into jan_sales values (11,sysdate - 60,250);

insert into jan_sales values (11,sysdate - 60,350);

insert into jan_sales values (11,sysdate - 60,200);

insert into jan_sales values (11,sysdate - 20,150);

insert into jan_sales values (11,sysdate - 20,250);

insert into jan_sales values (11,sysdate - 20,450);

insert into jan_sales values (11,sysdate - 20,550);

insert into jan_sales values (11,sysdate - 20,250);

insert into jan_sales values (11,sysdate - 20,350);
